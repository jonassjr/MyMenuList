...
-- AddForeignKey
ALTER TABLE "categories" ADD CONSTRAINT "categories_menusId_fkey" FOREIGN KEY ("menusId") REFERENCES "menus"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "items" ADD CONSTRAINT "items_menusId_fkey" FOREIGN KEY ("menusId") REFERENCES "menus"("id") ON DELETE SET NULL ON UPDATE CASCADE;
